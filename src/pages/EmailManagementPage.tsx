...
export const EmailManagementPage: React.FC<EmailManagementPageProps> = ({
  ...
  const { getEmailAccounts, signInWithGoogle } = useAuth();
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="flex items-center justify-center space-x-6 mb-6">
                  <button 
                    ...
                    className="w-12 h-12 rounded-full border-2 border-gray-300 flex items-center justify-center hover:border-[#57A777] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
